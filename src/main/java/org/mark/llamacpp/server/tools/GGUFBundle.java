...
public class GGUFBundle {
    ...
    private void resolveFiles(File inputFile) {
        ...
        if (matcher.matches()) {
            ...
            // If file is "qwen2-vl-7b-instruct-q4_k_m.gguf", base name might be "qwen2-vl-7b-instruct-q4_k_m"
    ...
    private void findMmproj(File directory, String baseName) {
        ...
        if (files != null && files.length > 0) {
            // Pick the one that seems most related (e.g. longest common substring or just the first one)
